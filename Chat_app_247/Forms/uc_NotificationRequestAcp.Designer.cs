...
{
    partial class uc_NotificationRequestAcp
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
            ...
            uc_Notifi_acp_Panel = new Guna.UI2.WinForms.Guna2Panel();
            ...
            uc_Notifi_acp_Panel.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)Avartar_Picture).BeginInit();
            SuspendLayout();
            // 
            // uc_Notifi_acp_Panel
            // 
            uc_Notifi_acp_Panel.BackColor = Color.FromArgb(44, 62, 80);
            uc_Notifi_acp_Panel.BorderColor = SystemColors.AppWorkspace;
            uc_Notifi_acp_Panel.BorderRadius = 2;
            uc_Notifi_acp_Panel.BorderThickness = 2;
            uc_Notifi_acp_Panel.Controls.Add(Bell_button);
            uc_Notifi_acp_Panel.Controls.Add(Label_text_accept);
            uc_Notifi_acp_Panel.Controls.Add(Name_Label);
            uc_Notifi_acp_Panel.Controls.Add(Avartar_Picture);
            uc_Notifi_acp_Panel.CustomizableEdges = customizableEdges2;
            uc_Notifi_acp_Panel.Dock = DockStyle.Fill;
            uc_Notifi_acp_Panel.Location = new Point(0, 0);
            uc_Notifi_acp_Panel.Name = "uc_Notifi_acp_Panel";
            uc_Notifi_acp_Panel.ShadowDecoration.CustomizableEdges = customizableEdges3;
            uc_Notifi_acp_Panel.Size = new Size(795, 122);
            uc_Notifi_acp_Panel.TabIndex = 2;
            // 
            // Bell_button
            // 
            Bell_button.FlatAppearance.BorderSize = 0;
            Bell_button.FlatStyle = FlatStyle.Flat;
            Bell_button.IconChar = FontAwesome.Sharp.IconChar.Check;
            Bell_button.IconColor = Color.PaleGreen;
            Bell_button.IconFont = FontAwesome.Sharp.IconFont.Solid;
            Bell_button.IconSize = 60;
            Bell_button.Location = new Point(652, 35);
            Bell_button.Name = "Bell_button";
            Bell_button.Size = new Size(56, 48);
            ...
            Label_text_accept.ForeColor = SystemColors.HotTrack;
            Label_text_accept.Location = new Point(328, 42);
            Label_text_accept.Name = "Label_text_accept";
            Label_text_accept.Size = new Size(317, 33);
            Label_text_accept.TabIndex = 17;
            Label_text_accept.Text = "Đã chấp nhận lời mời kết bạn";
            // 
            // Name_Label
            // 
            ...
            // 
            // uc_NotificationRequestAcp
            // 
            AutoScaleDimensions = new SizeF(8F, 20F);
            AutoScaleMode = AutoScaleMode.Font;
            Controls.Add(uc_Notifi_acp_Panel);
            Name = "uc_NotificationRequestAcp";
            Size = new Size(795, 122);
            uc_Notifi_acp_Panel.ResumeLayout(false);
            uc_Notifi_acp_Panel.PerformLayout();
        ...
        private Guna.UI2.WinForms.Guna2Panel uc_Notifi_acp_Panel;
